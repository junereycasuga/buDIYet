			...
			<div class="widget-container fluid-height clearfix">
				<div class="widget-content padded">
					...
					<div class="pull-right">
						<a href="<?php echo $this->createAbsoluteUrl('department/'); ?>" class="btn btn-primary btn-lg">Budget Your Own</a>
						<a href="<?php echo $this->createAbsoluteUrl('#'); ?>" class="btn btn-primary btn-lg"><i class="glyphicon glyphicon-thumbs-up"></i> Vote</a>
					</div>
				</div>
			</div>	
		</div>
